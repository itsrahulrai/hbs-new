...
export function GrowthSystemSection() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-28 bg-[#fbfbfe] text-[#0f172a]">
      ...
      <Container className="relative z-10 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-6 flex items-center justify-center">
            <div className="relative w-full overflow-hidden rounded-3xl border border-slate-200/80 bg-white/95 p-2 sm:p-3.5 shadow-[0_16px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-all duration-300 hover:shadow-[0_22px_65px_rgba(15,23,42,0.12)]">
              ...
              <div className="relative overflow-hidden rounded-2xl">
                <Image
                  ...
                  width={1440}
                  height={960}
                  className="w-full h-auto object-contain rounded-2xl transition-transform duration-500 hover:scale-[1.01]"
                  priority
                />
              </div>
            </div>
