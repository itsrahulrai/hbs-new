          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            ...
            >
              <button
                ...
                className={`flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-[6px] border border-slate-200/90 bg-white shadow-2xs transition-all duration-200 ${
                  canScrollLeft
