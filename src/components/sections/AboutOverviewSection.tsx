        ...
        <div className="grid gap-6 lg:gap-8 xl:gap-10 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <motion.h2
              ...
              className="mt-2.5 font-display text-[19px] sm:text-[24px] md:text-[25px] lg:text-[27px] xl:text-[29px] font-bold tracking-[-0.025em] text-[#0b132b] leading-[1.3] sm:leading-[1.26] [text-wrap:balance]"
            >
